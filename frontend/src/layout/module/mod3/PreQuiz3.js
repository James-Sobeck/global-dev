...
export default function PreQuiz3() {
            ...
            <>
              <div class="my-10 border-b border-gray-300 justify-center pr-5">
                <div class="relative z-10 h-auto p-8 py-10 overflow-hidden bg-white border-b-2 border-gray-300 rounded-lg shadow-2xl px-7">
                  ...
                  <form id="preQuiz">
                    <legend>
                    1. Do you think law enforcement as a whole uses excessive force?
                    </legend>
                    <div >
                    ...
                    <div class="my-12 border-b border-gray-300 lg:my-12"></div>
                    <legend>
                      2. Do you think law enforcement needs more hands on training?
                    </legend>
                    <div >
                    <label class="text-center text-gray-800 xl:text-xl pt-4">
                     Yes
                    ...
                    />
                     ...
                     <div class="my-12 border-b border-gray-300 lg:my-12"></div>
                    <legend>
                      3. As a law enforcement officer are you comfortable with your current restraining techniques?
                    </legend>
                    <div >
                    <label class="text-center text-gray-800 xl:text-xl pt-4">Yes</label>{" "}
                    <input
                      type="checkbox"
                      name="q3"
                      class="block w-full px-4 py-3 mb-4 border-2 border-gray-200 rounded-lg focus:ring focus:ring-blue-500 focus:outline-none"
                      value="Yes"
                    />
                    <label class="text-center text-gray-800 xl:text-xl">No</label>
                    <input
                      type="checkbox"
                      name="q3"
                      class="block w-full px-4 py-3 mb-4 border-2 border-gray-200 rounded-lg focus:ring focus:ring-blue-500 focus:outline-none"
                    ...
                    /></div>
                     <div class="my-12 border-b border-gray-300 lg:my-12"></div>
                    <legend>
                      4. Do you feel as though you are adequately prepared to address restrain and/or arrest someone twice your size without using a firearm?
                    </legend>
                    <div >
                    <label class="text-center text-gray-800 xl:text-xl pt-4">Yes</label>{" "}
                    <input
